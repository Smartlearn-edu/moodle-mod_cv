...
$string['show_review'] = 'عرض مراجعة الطلب المصاغ بالذكاء الاصطناعي';
$string['show_review_help'] = 'في حال التفعيل، سيتمكن الطالب من مراجعة نصوص الطلب المصاغة بالذكاء الاصطناعي على الشاشة بعد التوليد.';
$string['show_summary'] = 'عرض الملخص المهني (Professional Summary)';
$string['show_summary_help'] = 'في حال التفعيل، سيتم تضمين قسم الملخص المهني التنفيذي في واجهة المراجعة وملف PDF المصدّر.';
$string['attempt_settings'] = 'إعدادات المحاولات وحد التوليد';
$string['max_attempts'] = 'المحاولات المسموح بها';
$string['max_attempts_help'] = 'الحد الأقصى لعدد المرات التي يمكن للطالب فيها توليد أو تحديث السيرة الذاتية بواسطة الذكاء الاصطناعي. اختر بلا حد للسماح بتوليد غير محدود.';
$string['unlimited'] = 'بلا حد (غير محدود)';
$string['attempts_count'] = 'المحاولات: {$a->used} من {$a->max}';
$string['attempts_remaining'] = 'لديك {$a} محاولة متبقية.';
$string['attempts_exhausted'] = 'لقد استنفدت الحد الأقصى للمحاولات المسموح بها ({$a}) في هذا النشاط. يمكنك مراجعة وتحميل ملف السيرة الذاتية الذي تم إنشاؤه مسبقاً أدناه.';
$string['error_max_attempts_reached'] = 'لقد استنفدت الحد الأقصى للمحاولات المسموح بها في هذا النشاط ({$a}).';
...
$string['help_date_select'] = 'حدد اليوم والشهر والسنة';

// Project Fields Configuration strings.
$string['project_fields_settings'] = 'حقول خبرات المشاريع';
$string['project_fields_settings_help'] = 'قم بتخصيص الحقول التي يجب على المرشحين تعبئتها لكل مشروع. يمكنك إضافة حقول مخصصة جديدة، وتعديل الحقول الحالية، وتحديد ما إذا كانت مطلوبة أو اختيارية، وتغيير الترتيب وإخفاء الحقول.';
$string['add_custom_field'] = 'إضافة حقل';
$string['edit_field'] = 'تعديل الحقل';
$string['delete_field'] = 'حذف الحقل';
$string['reset_default_fields'] = 'استعادة الحقول الافتراضية';
$string['confirm_reset_fields'] = 'هل أنت متأكد من رغبتك في إعادة ضبط جميع الحقول على الإعدادات الافتراضية؟ سيتم حذف الحقول المخصصة.';
$string['confirm_delete_field'] = 'هل أنت متأكد من رغبتك في حذف هذا الحقل؟';
$string['field_label'] = 'عنوان الحقل';
$string['field_key'] = 'معرف الحقل (Key)';
$string['field_type'] = 'نوع الحقل';
$string['field_section'] = 'القسم';
$string['field_required'] = 'حقل إلزامي';
$string['field_placeholder'] = 'النص التوضيحي (Placeholder)';
$string['field_options'] = 'الخيارات (للقائمة المنسدلة)';
$string['field_options_help'] = 'أدخل كل خيار في سطر جديد أو مفصولاً بفواصل.';
$string['field_helptext'] = 'نص المساعدة والشرح';
...
$string['section_governance'] = 'المعنيون والموارد والحوكمة';
$string['section_custom'] = 'حقول مخصصة';
$string['type_text'] = 'نص سطر واحد';
$string['type_textarea'] = 'نص متعدد الأسطر';
$string['type_select'] = 'قائمة منسدلة';
$string['type_date'] = 'تاريخ';
$string['type_number'] = 'رقم';
$string['type_checkbox'] = 'مربع اختيار';
$string['action_move_up'] = 'تحريك لأعلى';
$string['action_move_down'] = 'تحريك لأسفل';
$string['action_toggle_visibility'] = 'تبديل الظهور';
$string['save_field'] = 'حفظ الحقل';
$string['error_field_key_required'] = 'معرف الحقل مطلوب ويجب أن يحتوي على أحرف وأرقام وشرطة سفلية فقط.';
$string['error_field_label_required'] = 'عنوان الحقل مطلوب.';
$string['error_field_key_duplicate'] = 'يوجد حقل مسبقاً بنفس هذا المعرف.';
...
$string['btn_copy_all'] = 'نسخ المخرجات';
$string['btn_modal_window'] = 'نافذة منبثقة';
$string['btn_view_output_window'] = 'عرض المخرجات';
$string['modal_output_title'] = 'مراجعة المخرجات بالذكاء الاصطناعي';
$string['copied_all_success'] = 'تم نسخ المخرجات إلى الحافظة!';
...
$string['privacy:metadata:cv_submissions:attempts'] = 'عدد محاولات توليد السيرة الذاتية المكتملة بواسطة المستخدم.';
