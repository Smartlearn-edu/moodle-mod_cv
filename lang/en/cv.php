...
$string['show_review'] = 'Show AI-Formatted Application Review';
$string['show_review_help'] = 'When enabled, students can review the AI-formatted application write-ups on screen after generation.';
$string['show_summary'] = 'Show Professional Summary';
$string['show_summary_help'] = 'When enabled, the executive professional summary will be included in the review display and the PDF export.';
$string['attempt_settings'] = 'Attempts & Generation Limit';
$string['max_attempts'] = 'Attempts Allowed';
$string['max_attempts_help'] = 'The maximum number of times a student can generate or update their CV/application using AI. Select Unlimited to allow unrestricted generations.';
$string['unlimited'] = 'Unlimited';
$string['attempts_count'] = 'Attempts: {$a->used} / {$a->max}';
$string['attempts_remaining'] = 'You have {$a} attempt(s) remaining.';
$string['attempts_exhausted'] = 'You have reached the maximum allowed attempts ({$a}) for this activity. You can review and download your previously generated dossier below.';
$string['error_max_attempts_reached'] = 'You have reached the maximum number of attempts allowed for this activity ({$a}).';
...
$string['field_title'] = 'Project Name';
...
$string['field_role'] = 'Project Role';
...
$string['help_date_select'] = 'Select Day, Month, and Year';

// Project Fields Configuration strings.
$string['project_fields_settings'] = 'Project Experience Fields';
$string['project_fields_settings_help'] = 'Configure the fields that candidates must fill in for each project experience entry. You can add new custom fields, edit existing field settings, toggle visibility, and reorder fields.';
$string['add_custom_field'] = 'Add Field';
$string['edit_field'] = 'Edit Field';
$string['delete_field'] = 'Delete Field';
$string['reset_default_fields'] = 'Reset to Default Fields';
$string['confirm_reset_fields'] = 'Are you sure you want to reset all project fields to the default configuration? Any custom fields will be removed.';
$string['confirm_delete_field'] = 'Are you sure you want to delete this field?';
$string['field_label'] = 'Field Label';
$string['field_key'] = 'Field Identifier / Key';
$string['field_type'] = 'Field Type';
$string['field_section'] = 'Section';
$string['field_required'] = 'Required Field';
$string['field_placeholder'] = 'Placeholder Text';
$string['field_options'] = 'Options (for Dropdown)';
$string['field_options_help'] = 'Enter each option on a new line or separated by commas (e.g., Option 1, Option 2).';
$string['field_helptext'] = 'Help / Description Text';
...
$string['section_governance'] = 'Stakeholders, Resources & Governance';
$string['section_custom'] = 'Custom Fields';
$string['type_text'] = 'Single-line Text';
$string['type_textarea'] = 'Multi-line Textarea';
$string['type_select'] = 'Dropdown Selection';
$string['type_date'] = 'Date';
$string['type_number'] = 'Number';
$string['type_checkbox'] = 'Checkbox';
$string['action_move_up'] = 'Move Up';
$string['action_move_down'] = 'Move Down';
$string['action_toggle_visibility'] = 'Toggle Visibility';
$string['save_field'] = 'Save Field';
$string['error_field_key_required'] = 'Field identifier is required and must contain only alphanumeric characters and underscores.';
$string['error_field_label_required'] = 'Field label is required.';
$string['error_field_key_duplicate'] = 'A field with this identifier already exists.';
...
$string['btn_copy_all'] = 'Copy Output';
$string['btn_modal_window'] = 'Popup Window';
$string['btn_view_output_window'] = 'View Output';
$string['modal_output_title'] = 'AI-Formatted Application Review';
$string['copied_all_success'] = 'All output copied to clipboard!';
...
$string['privacy:metadata:cv_submissions:attempts'] = 'The number of AI CV generation attempts completed by the user.';
